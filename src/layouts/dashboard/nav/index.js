...
const StyledAccount = styled('div')(({ theme }) => ({
  ...
  backgroundColor: alpha(theme.palette.grey[400], 0.42),
}));
...
export default function Nav({ openNav, onCloseNav }) {
  ...
  const renderContent = (
    <Scrollbar
      sx={{
        height: 1,
        '& .simplebar-content': { height: 5, display: 'flex', flexDirection: 'column' },
      }}
    >
      <Box sx={{ px: 2.5, py: 1, display: 'inline-flex' }}> </Box>
